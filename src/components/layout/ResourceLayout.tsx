...
export function ResourceLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header className="sticky top-0 z-50 p-4 md:p-6 backdrop-blur-lg bg-background/80 border-b border-border">
        <div className="container max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link to="/blog" className={cn("text-sm transition", isActive("/blog") ? "text-statusnow-purple" : "hover:text-statusnow-purple")}>Blog</Link>
            <Link to="/help-center" className={cn("text-sm transition", isActive("/help-center") ? "text-statusnow-purple" : "hover:text-statusnow-purple")}>Help Center</Link>
            <Link to="/community" className={cn("text-sm transition", isActive("/community") ? "text-statusnow-purple" : "hover:text-statusnow-purple")}>Community</Link>
            <Link to="/startup-guide" className={cn("text-sm transition", isActive("/startup-guide") ? "text-statusnow-purple" : "hover:text-statusnow-purple")}>Startup Guide</Link>
            <div className="relative group">
              ...
              <div className="absolute left-0 top-full mt-2 bg-popover border border-border rounded-md shadow-lg p-2 w-40 hidden group-hover:block">
                <Link to="/about-us" className={cn("block px-3 py-2 text-sm rounded-md", isActive("/about-us") ? "bg-muted" : "hover:bg-muted")}>About Us</Link>
                <Link to="/careers" className={cn("block px-3 py-2 text-sm rounded-md", isActive("/careers") ? "bg-muted" : "hover:bg-muted")}>Careers</Link>
                <Link to="/privacy-policy" className={cn("block px-3 py-2 text-sm rounded-md", isActive("/privacy-policy") ? "bg-muted" : "hover:bg-muted")}>Privacy Policy</Link>
                <Link to="/terms-of-service" className={cn("block px-3 py-2 text-sm rounded-md", isActive("/terms-of-service") ? "bg-muted" : "hover:bg-muted")}>Terms of Service</Link>
              </div>
            </div>
          </div>
